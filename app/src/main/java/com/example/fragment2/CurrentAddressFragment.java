 ...
 * Use the {@link CurrentAddressFragment#newInstance} factory method to
...
public class CurrentAddressFragment extends Fragment {
     ...
     * @return A new instance of fragment CurrentAddressFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button button =(Button) view.findViewById(R.id.AddYourAddressButton);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_currentAddressFragment_to_findYourAddressFragment);
